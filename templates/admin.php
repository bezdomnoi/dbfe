...
<form id="FORM_ADMIN_USERS" action="admin.php" method="post" onsubmit="return checkFields(this);">
	<fieldset>
		...
		<input type="text" name="user_id" id="user_id" value="<?php echo $selected_user['user_id']; ?>" disabled /><br>
		<label for="user_email">User Email :</label>
		<input type="email" name="user_email" id="user_email" value="<?php echo $selected_user['user_email']; ?>" pattern=".+@.+\..+" /><br>
		<label for="user_display">Display name :</label>
		<input type="text" name="user_display" id="user_display" value="<?php echo $selected_user['user_display'] ?>" /><br>
